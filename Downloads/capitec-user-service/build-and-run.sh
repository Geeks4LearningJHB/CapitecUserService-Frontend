...
docker tag capitec-user-service-frontend:amd64 thapeloseema/capitec-user-service:frontend-amd64

docker push thapeloseema/capitec-user-service:frontend-amd64
