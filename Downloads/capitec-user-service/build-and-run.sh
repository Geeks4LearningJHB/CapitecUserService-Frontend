...
docker tag capitec-user-service-frontend:amd64 thapeloseema/capitec-user-service:frontend-amd64v1.0.3

docker push thapeloseema/capitec-user-service:frontend-amd64v1.0.3
